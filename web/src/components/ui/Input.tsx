...
const variantClasses: Record<InputVariant, string> = {
  ...
  dark: 'w-full bg-green-800 border-[1.5px] border-green-700 focus:border-citrus rounded-xl px-4 py-3 font-sans text-sm text-surface placeholder:text-green-500 outline-none',
};
